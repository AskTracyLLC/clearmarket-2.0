  ...
  public: {
    Tables: {
      ...
      admin_email_access_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "admin_email_access_log_admin_id_fkey"
            columns: ["admin_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "admin_email_access_log_target_profile_id_fkey"
      ...
      pending_credit_purchases: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["vendor_id"]
            isOneToOne: false
            referencedRelation: "vendor_onboarding_status"
